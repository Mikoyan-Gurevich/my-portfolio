...
class Resume extends Component {
    ...
    printResume() {
        ...
        let pri = document.getElementById('resumeToPrint').contentWindow;
        pri.document.open();
        pri.document.write(content.innerHTML);
        var head = pri.document.getElementsByTagName('head')[0];
        var style = pri.document.createElement("style");
    ...
    render() {
        return (
            <React.Fragment>
                <iframe name='resumeContent' style={{ height: '0', width: '0', position: 'absolute', visibility: 'hidden' }} id='resumeToPrint'></iframe>
                <div id='resume'>
